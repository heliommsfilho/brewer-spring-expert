...
public class Mailer {
	...
	public void enviar(Venda venda) {
		...
		try {
			...
			helper.setFrom("heliommsfilho@gmail.com");
			...
			for(String cid : fotos.keySet()) {
				...
				String fotoContentType = fotos.get(cid).split("\\|")[1];
				byte[] arrayFoto = fotoStorage.recuperarThumbnail(foto);
				helper.addInline(cid, new ByteArrayResource(arrayFoto), fotoContentType);
			}
